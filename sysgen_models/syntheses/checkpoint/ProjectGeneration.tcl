...
namespace eval ::xilinx::dsp::planaheaddriver {
	proc additional_tcl_commands {} { 
		...
		set_property USED_IN {out_of_context synthesis implementation} [get_files syntheses_clock.xdc]
		launch_runs synth_1
		wait_on_run synth_1
		open_run synth_1 -name netlist_1
		write_checkpoint syntheses.dcp -force
	}
	...
	set ProjectFiles {
		...
		{{xlclockdriver_rd.v}}
		{{vivado_ip.tcl}}
		{{syntheses_entity_declarations.v}}
		{{syntheses.v}}
		{{syntheses_clock.xdc}}
		{{syntheses.xdc}}
		{{syntheses.htm}}
	...
	dict set TopLevelPortInterface ready_out DatFile {syntheses_implementation_interface_out_ready_out.dat}
	...
	dict set TopLevelPortInterface ready_out ClockDomain {syntheses}
	...
	dict set TopLevelPortInterface valid_in DatFile {syntheses_implementation_interface_in_valid_in.dat}
	...
	dict set TopLevelPortInterface valid_in ClockDomain {syntheses}
	...
	dict set TopLevelPortInterface set_stb_in DatFile {syntheses_implementation_interface_in_set_stb_in.dat}
	...
	dict set TopLevelPortInterface set_stb_in ClockDomain {syntheses}
	...
	dict set TopLevelPortInterface set_data_in DatFile {syntheses_implementation_interface_in_set_data_in.dat}
	...
	dict set TopLevelPortInterface set_data_in ClockDomain {syntheses}
	...
	dict set TopLevelPortInterface set_addr_in DatFile {syntheses_implementation_interface_in_set_addr_in.dat}
	...
	dict set TopLevelPortInterface set_addr_in ClockDomain {syntheses}
	...
	dict set TopLevelPortInterface reset_in DatFile {syntheses_implementation_interface_in_reset_in.dat}
	...
	dict set TopLevelPortInterface reset_in ClockDomain {syntheses}
	...
	dict set TopLevelPortInterface last_in DatFile {syntheses_implementation_interface_in_last_in.dat}
	...
	dict set TopLevelPortInterface last_in ClockDomain {syntheses}
	...
	dict set TopLevelPortInterface data_in DatFile {syntheses_implementation_interface_in_data_in.dat}
	...
	dict set TopLevelPortInterface data_in ClockDomain {syntheses}
	...
	dict set TopLevelPortInterface ready_in DatFile {syntheses_implementation_interface_in_ready_in.dat}
	...
	dict set TopLevelPortInterface ready_in ClockDomain {syntheses}
	...
	dict set TopLevelPortInterface data_out DatFile {syntheses_implementation_interface_out_data_out.dat}
	...
	dict set TopLevelPortInterface data_out ClockDomain {syntheses}
	...
	dict set TopLevelPortInterface last_out DatFile {syntheses_implementation_interface_out_last_out.dat}
	...
	dict set TopLevelPortInterface last_out ClockDomain {syntheses}
	...
	dict set TopLevelPortInterface valid_out DatFile {syntheses_implementation_interface_out_valid_out.dat}
	...
	dict set TopLevelPortInterface valid_out ClockDomain {syntheses}
	...
	dict set TopLevelPortInterface clk ClockDomain {syntheses}
