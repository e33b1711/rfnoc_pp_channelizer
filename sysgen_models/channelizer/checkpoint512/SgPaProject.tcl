                                  ...
                                  if {[dict exists $port_interface AssociatedInterfaces]} {
                                      ...
                                      if { [llength $associated_interfaces] > 0 } {                                        
                                        foreach associated_interface $associated_interfaces {
                                          append associated_interfaces_string $associated_interface 
                                          append associated_interfaces_string ":"
                                        }
                                        set sep ":" 
                                      }
                                  }                    
   ...
   proc dsp_extract_timing_paths {delayTypes hdlNetlistFiles} {
       ...
       foreach delayType $delayTypes {
           ...
           foreach path $timing_paths {
               ### DEBUG
               # set i [expr {$i + 1}]
               # puts "DEBUG: Vivado Timing Path Number: $i "
               ...
               if { [ llength $resList ] == 1 } { # list contains only launch_cell
                   continue
               }
               ...
               #     puts "Capture Clock: $capture_clk_name is propagated."
               # } else {
               #     puts "Capture Clock: $capture_clk_name is not propagated."
               # }
               ...
               if { $num_path_cells > 2 } {
                   ...
                   foreach path_cell $path_cells {
                       ...
                       if { [ llength $resList ] == 1 } { # list contains only path_cell
                           continue
               ...
               if { [ llength $capture_cell ] > 0 } {
                   ...
                   if { [ llength $resList ] > 1 } { # list contains capture_cell and other related data
                       if { [ llength $resList ] == 2 } {
                           puts "Timing Analyze Info: Cannot find relevant block name in SysGen design for capture cell, $capture_cell ."
                           set hier_cell [ lindex $resList 0 ]
                           set ref_name  [ lindex $resList 1 ]
                           ### DEBUG
                           # puts "Timing Analyzer Info: The highest level of cell instance in Vivado database, $hier_cell ."
