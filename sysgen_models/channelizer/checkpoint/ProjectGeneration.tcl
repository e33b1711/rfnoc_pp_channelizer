...
namespace eval ::xilinx::dsp::planaheaddriver {
	proc additional_tcl_commands {} { 
		...
		set_property USED_IN {out_of_context synthesis implementation} [get_files channelizer_clock.xdc]
		launch_runs synth_1
		wait_on_run synth_1
		open_run synth_1 -name netlist_1
		write_checkpoint channelizer.dcp -force
	}
	...
	set ProjectFiles {
		...
		{{xlclockdriver_rd.v}}
		{{vivado_ip.tcl}}
		{{channelizer_blk_mem_gen_v8_2_0_vivado.coe}}
		{{channelizer_entity_declarations.v}}
		{{channelizer.v}}
		{{channelizer_clock.xdc}}
		{{channelizer.xdc}}
		{{channelizer.htm}}
	}
	set SimPeriod 1
	...
	dict set TopLevelPortInterface ready_out DatFile {channelizer_implementation_interface_out_ready_out.dat}
	...
	dict set TopLevelPortInterface ready_out ClockDomain {channelizer}
	...
	dict set TopLevelPortInterface valid_in DatFile {channelizer_implementation_interface_in_valid_in.dat}
	...
	dict set TopLevelPortInterface valid_in ClockDomain {channelizer}
	...
	dict set TopLevelPortInterface set_stb_in DatFile {channelizer_implementation_interface_in_set_stb_in.dat}
	...
	dict set TopLevelPortInterface set_stb_in ClockDomain {channelizer}
	...
	dict set TopLevelPortInterface set_data_in DatFile {channelizer_implementation_interface_in_set_data_in.dat}
	...
	dict set TopLevelPortInterface set_data_in ClockDomain {channelizer}
	...
	dict set TopLevelPortInterface set_addr_in DatFile {channelizer_implementation_interface_in_set_addr_in.dat}
	...
	dict set TopLevelPortInterface set_addr_in ClockDomain {channelizer}
	...
	dict set TopLevelPortInterface reset_in DatFile {channelizer_implementation_interface_in_reset_in.dat}
	...
	dict set TopLevelPortInterface reset_in ClockDomain {channelizer}
	...
	dict set TopLevelPortInterface last_in DatFile {channelizer_implementation_interface_in_last_in.dat}
	...
	dict set TopLevelPortInterface last_in ClockDomain {channelizer}
	...
	dict set TopLevelPortInterface data_in DatFile {channelizer_implementation_interface_in_data_in.dat}
	...
	dict set TopLevelPortInterface data_in ClockDomain {channelizer}
	...
	dict set TopLevelPortInterface ready_in DatFile {channelizer_implementation_interface_in_ready_in.dat}
	...
	dict set TopLevelPortInterface ready_in ClockDomain {channelizer}
	...
	dict set TopLevelPortInterface data_out DatFile {channelizer_implementation_interface_out_data_out.dat}
	...
	dict set TopLevelPortInterface data_out ClockDomain {channelizer}
	...
	dict set TopLevelPortInterface last_out DatFile {channelizer_implementation_interface_out_last_out.dat}
	...
	dict set TopLevelPortInterface last_out ClockDomain {channelizer}
	...
	dict set TopLevelPortInterface valid_out DatFile {channelizer_implementation_interface_out_valid_out.dat}
	...
	dict set TopLevelPortInterface valid_out ClockDomain {channelizer}
	...
	dict set TopLevelPortInterface clk ClockDomain {channelizer}
