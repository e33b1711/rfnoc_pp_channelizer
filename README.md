...
Always put a packet-resizer block behind the channelizer/ syntheses block(like in the example graphs) or you will get timeouts instead of output. Its someting about the tlast, i'll have to figure out.
